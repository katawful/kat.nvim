(module katdotnvim.exported.integrations.startify-light-soft
...
(defn render []
 [
  ...
  {:bg "SKIP" :ctermbg "SKIP" :ctermfg 4 :fg "#111c1f" :group "StartifyPath"}
  {:bg "SKIP" :ctermbg "SKIP" :ctermfg 7 :fg "#6285c0" :group "StartifySlash"}
  {:bg "SKIP"
   :bold true
   :ctermbg "SKIP"
   :ctermfg 9
  ...
  {:bg "SKIP" :ctermbg "SKIP" :ctermfg 12 :fg "#111c1f" :group "StartifySpecial"}
