(module katdotnvim.exported.syntax-dark-soft
...
(defn render []
 [
  ...
  {:bg "SKIP"   :ctermbg "SKIP"   :ctermfg 13   :fg "#f1b8c7"   :group "Float"}
  ...
  {:bg "#eb4949"   :bold true   :ctermbg 1   :ctermfg 7   :fg "#f0f8fb"   :group "Error"}

  {:bg "#f2b86c"   :ctermbg 3   :ctermfg 0   :fg "#202f47"   :group "Todo"}
