...
(defn high-colors []
  [
    ...
    {:group :Identifier
     ...
     :ctermbg :SKIP}
    {:group :Function
     :fg (ucolors.saturation (ucolors.brighten (ucolors.blend (. (identifier) 1)
                                                              (. (groups.errorBG) 1)
                                                              0.3)
                                               0.10)
                             0.5)
    ...
    (fn [] (if (= vim.o.background :light)
               {:group :Variable
                :fg (ucolors.darken (ucolors.blend  (. (identifier) 1)
                                                    (. (colors.foreground) 6)
                                                    0.5)
                                    0.4)
                :bg :SKIP
               ...
               {:group :Variable
                :fg (ucolors.brighten (ucolors.blend  (. (identifier) 1)
                                                      (. (colors.foreground) 6)
                                                      0.5)
                                      0.4)
                :bg :SKIP
    ...
    {:group :Repeat
     :fg (ucolors.saturation (ucolors.brighten (ucolors.blend  (. (statement) 1)
                                                               (. (groups.infoBG) 1)
                                                               0.2)
                                               0.3)
                             0.8)
    ...
    (fn [] (if (= vim.o.background :light)
               (do {:group :Keyword
                    :fg (ucolors.darken (ucolors.blend  (. (statement) 1)
                                                        (. (groups.auxBG) 1)
                                                        0.2)
                                        0.5)
                    :bg :SKIP
