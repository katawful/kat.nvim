...
(defn high-colors []
  [
    ...
    {:group :EndOfBuffer
     ...
     :bold true}
    {:group :Directory
     :fg (ucolors.blend  (ucolors.blend (. (infoBG) 1)
                                        (. (mainFG) 1)
                                        0.1)
                        (. (selectionBG) 1)
                        0.2)
    ...
    {:group :StatusLine
     ...
     :bg (ucolors.blend (. (highlightBG) 1)
                        (. (mainBG) 1)
                        0.7)
     :ctermfg (. (umbraBG) 2)
    ...
    {:group :StatusLineNC
     :fg (ucolors.blend (. (highlightBG) 1)
                        (. (mainBG) 1)
                        0.7)
    ...
    {:group :VisualNOS
     :fg :SKIP
     :bg (ucolors.blend (. (selectionBG) 1)
                        (. (mainFG) 1)
                        0.5)
     :ctermfg :SKIP
     :ctermbg (. (warningBG) 2)}
