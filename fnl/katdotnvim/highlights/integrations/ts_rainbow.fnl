...
(defn init []
  (ucolors.highlight :rainbowcol1
                     (ucolors.blendColors (. (colors.init :normalColors) :red)
                                          (. (groups.meldFG) 1)
                                          0.8)
                     :SKIP
                     1
  ...
  (ucolors.highlight :rainbowcol2
                     (ucolors.blendColors (. (colors.init :normalColors) :pink)
                                          (. (groups.meldFG) 1)
                                          0.8)
                     :SKIP
                     2
  ...
  (ucolors.highlight :rainbowcol3
                     (ucolors.blendColors (. (colors.init :normalColors) :purple)
                                          (. (groups.meldFG) 1)
                                          0.8)
                     :SKIP
                     3
  ...
  (ucolors.highlight :rainbowcol4
                     (ucolors.blendColors (. (colors.init :normalColors) :blue)
                                          (. (groups.meldFG) 1)
                                          0.8)
                     :SKIP
                     4
  ...
  (ucolors.highlight :rainbowcol5
                     (ucolors.blendColors (. (colors.init :normalColors) :green)
                                          (. (groups.meldFG) 1)
                                          0.8)
                     :SKIP
                     5
  ...
  (ucolors.highlight :rainbowcol6
                     (ucolors.blendColors (. (colors.init :normalColors) :orange)
                                          (. (groups.meldFG) 1)
                                          0.8)
                     :SKIP
                     6
