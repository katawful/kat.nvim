...
(defn high-colors []
 [
   ...
   {:group :TSField
    :fg (ucolors.brighten (ucolors.blend  (. (syntax.identifier) 1)
   ...
   {:group :TSMethod
    :fg (ucolors.saturation (ucolors.brighten (ucolors.blend  (. (syntax.identifier) 1)
                                                              (. (colors.init :normalColors) :red)
                                                              0.3)
                                              0.10)
                            0.1)
   ...
   (fn [] (if (= vim.g.kat_nvim_style :light)
              (do {:group :TSNamespace
                   :fg (ucolors.darken (ucolors.blend  (. (syntax.identifier) 1)
   ...
   {:group :TSKeywordFunction
    :fg (ucolors.brighten (ucolors.blend  (. (syntax.statement) 1)
                                          (. (colors.init :normalColors) :green)
                                          0.2)
                          0.1)
    :bg :SKIP
