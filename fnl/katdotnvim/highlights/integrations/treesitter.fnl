...
(defn init []
  ...
  (ucolors.highlight :TSField
                     (ucolors.brighten (ucolors.blendColors (. (syntax.identifier) 1)
  ...
  (ucolors.highlight :TSFuncBuiltin
                     (ucolors.blendColors (. (syntax.identifier) 1)
  ...
  (ucolors.highlight :TSFuncMacro
                     (ucolors.blendColors (. (syntax.preproc) 1)
                                          (. (syntax.identifier) 1)
                                          0.2)
                     :SKIP
                     (. (groups.errorBG) 2)
  ...
  (ucolors.highlight :TSMethod
                     (ucolors.saturation (ucolors.brighten (ucolors.blendColors (. (syntax.identifier) 1)
                                                                                (. (colors.init :normalColors) :red)
                                                                                0.3)
                                                           0.10)
                                         0.1)
  ...
  (ucolors.highlight :TSVariableBuiltin
                     (ucolors.darken (ucolors.blendColors (. (syntax.identifier) 1)
  ...
  (ucolors.highlight :TSConstructor
                     (ucolors.blendColors (. (syntax.typeDef) 1)
                                          (. (colors.init :normalColors) :red)
                                          0.4)
                     :SKIP
                     (. (groups.infoBG) 2)
  ...
  (ucolors.highlight :TSConstBuiltin
                     (ucolors.darken (ucolors.blendColors (. (groups.fillBG) 1)
  ...
  (ucolors.highlight :TSKeywordFunction
                     (ucolors.brighten (ucolors.blendColors (. (syntax.statement) 1)
                                                            (. (colors.init :normalColors) :green)
                                                            0.2)
                                       0.1)
                     :SKIP
  ...
  (ucolors.highlight :TSTagDelimiter
                     (ucolors.darken (ucolors.blendColors (. (syntax.preproc) 1)
                                                          (. (colors.init :normalColors) :red)
                                                          0.4)
                                     0.2)
                     :SKIP
  ...
  (ucolors.highlight :TSStringRegex
                     (ucolors.blendColors stringColor
                                          (. (colors.init :normalColors) :blue)
                                          0.5)
                     :SKIP
                     (. (groups.selectionBG) 2)
  ...
  (ucolors.highlight :TSSymbol
                     (ucolors.saturation (ucolors.blendColors stringColor
                                                              (. (colors.init :normalColors) :purple)
                                                              0.3)
                                         0.8)
                     :SKIP
