...
local function output_21()
  local file_name = string.format("konsole-%s-%s.colorscheme", tostring(vim.g.colors_name), tostring((main["background-mut"])[1]))
