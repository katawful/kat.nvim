...
local a, alacritty, colors, groups, hsl, kitty, main, ucolors, _ = autoload("katdotnvim.aniseed.core"), autoload("katdotnvim.utils.export.alacritty"), autoload("katdotnvim.color"), autoload("katdotnvim.highlights.main"), autoload("externals.hsluv"), autoload("katdotnvim.utils.export.kitty"), autoload("katdotnvim.main"), autoload("katdotnvim.utils.color"), nil
