...
local a, alacritty, colors, errors, groups, hsl, kitty, main, rxvt, ucolors, _ = autoload("katdotnvim.aniseed.core"), autoload("katdotnvim.utils.export.alacritty"), autoload("katdotnvim.color"), autoload("katdotnvim.utils.errors"), autoload("katdotnvim.highlights.main"), autoload("externals.hsluv"), autoload("katdotnvim.utils.export.kitty"), autoload("katdotnvim.main"), autoload("katdotnvim.utils.export.rxvt"), autoload("katdotnvim.utils.color"), nil
