local _2afile_2a = "fnl/katdotnvim/exported/filetype/markdown-light-soft.fnl"
local _2amodule_name_2a = "katdotnvim.exported.filetype.markdown-light-soft"
local _2amodule_2a
do
