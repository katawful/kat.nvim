local _2afile_2a = "fnl/katdotnvim/exported/integrations/ts_rainbow-dark-soft.fnl"
local _2amodule_name_2a = "katdotnvim.exported.integrations.ts_rainbow-dark-soft"
local _2amodule_2a
do
