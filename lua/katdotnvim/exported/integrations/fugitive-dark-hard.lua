local _2afile_2a = "fnl/katdotnvim/exported/integrations/fugitive-dark-hard.fnl"
local _2amodule_name_2a = "katdotnvim.exported.integrations.fugitive-dark-hard"
local _2amodule_2a
do
