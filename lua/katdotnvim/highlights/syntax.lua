...
local function init()
  ...
  ucolors.highlight("Character", ucolors.blendColors(groups.auxBG()[1], groups.mainFG()[1], 0.5), "SKIP", groups.auxBG()[3], "SKIP", "bold")
  ucolors.highlight("Number", groups.fillBG()[1], "SKIP", groups.fillBG()[2], "SKIP")
  ucolors.highlight("Float", ucolors.blendColors(groups.fillBG()[1], groups.mainFG()[1], 0.7), "SKIP", groups.fillBG()[3], "SKIP")
  ucolors.highlight("Boolean", ucolors.blendColors(groups.selectionBG()[1], groups.mainFG()[1], 0.7), "SKIP", groups.selectionBG()[3], "SKIP", "bold")
  ...
  ucolors.highlight("Repeat", ucolors.saturation(ucolors.brighten(ucolors.blendColors(statement()[1], groups.infoBG()[1], 0.2), 0.3), 0.8), "SKIP", groups.infoBG()[2], "SKIP")
  ucolors.highlight("Label", ucolors.saturation(ucolors.blendColors(statement()[1], groups.fillBG()[1], 0.2), 1), "SKIP", groups.fillBG()[2], "SKIP", "bold")
  ucolors.highlight("Operator", ucolors.blendColors(statement()[1], groups.meldFG()[1], 0.2), "SKIP", groups.mainFG()[2], "SKIP", "bold")
  if (vim.o.background == "light") then
    ucolors.highlight("Keyword", ucolors.darken(ucolors.blendColors(statement()[1], groups.auxBG()[1], 0.2), 0.5), "SKIP", groups.auxBG()[3], "SKIP", "italic")
  else
    ucolors.highlight("Keyword", ucolors.brighten(ucolors.blendColors(statement()[1], groups.auxBG()[1], 0.2), 0.5), "SKIP", groups.auxBG()[3], "SKIP", "italic")
  end
  ucolors.highlight("Exception", ucolors.brighten(ucolors.blendColors(statement()[1], groups.selectionBG()[1], 0.1), 0.2), "SKIP", groups.selectionBG()[2], "SKIP")
  ucolors.highlight("PreProc", preproc()[1], "SKIP", preproc()[2], "SKIP", "bold,italic")
  ucolors.highlight("Include", ucolors.blendColors(preproc()[1], groups.errorBG()[1], 0.2), "SKIP", preproc()[2], "SKIP", "bold,italic")
  ucolors.highlight("Define", ucolors.blendColors(preproc()[1], groups.highlightBG()[1], 0.2), "SKIP", groups.highlightBG()[3], "SKIP", "bold,italic")
  ucolors.highlight("Macro", ucolors.blendColors(preproc()[1], groups.selectionBG()[1], 0.2), "SKIP", groups.selectionBG()[3], "SKIP", "bold,italic")
  ucolors.highlight("PreCondit", ucolors.blendColors(preproc()[1], groups.auxBG()[1], 0.2), "SKIP", groups.auxBG()[3], "SKIP", "bold,italic")
  ...
  ucolors.highlight("diffAdded", ucolors.blendColors(groups.auxBG()[1], groups.mainFG()[1], 0.4), ucolors.blendColors(groups.auxBG()[1], groups.mainBG()[1], 0.6), groups.mainFG()[2], groups.auxBG()[3], "bold")
  ucolors.highlight("diffChanged", ucolors.blendColors(groups.selectionBG()[1], groups.mainFG()[1], 0.4), ucolors.blendColors(groups.selectionBG()[1], groups.mainBG()[1], 0.6), groups.mainFG()[2], groups.selectionBG()[3], "bold")
