...
local function warningBG()
  local output = {ucolors.blendColors((colors["normal-colors"]()).red, mainBG()[1], 0.7), 9}
  return output
end
...
local function init()
  ...
  ucolors.highlight("StatusLine", colors.background()[5], ucolors.blendColors(highlightBG()[1], mainBG()[1], 0.7), umbraBG()[2], highlightBG()[3], "bold")
  ucolors.highlight("StatusLineNC", ucolors.blendColors(highlightBG()[1], mainBG()[1], 0.7), colors.background()[5], umbraBG()[2], highlightBG()[3], "bold")
  if ((vim.o.background == "dark") and (main.katContrast == "soft")) then
