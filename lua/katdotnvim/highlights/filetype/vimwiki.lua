...
local function init()
  ucolors.highlight("VimwikiMarkers", colors.background[5], "SKIP")
  ...
  ucolors.highlight("VimwikiHeader1", ucolors.darken(colors.normalColors.blue, 0), "SKIP", "bold")
  ucolors.highlight("VimwikiHeader2", ucolors.darken(colors.normalColors.blue, 0.3), "SKIP", "bold")
  ucolors.highlight("VimwikiHeader3", ucolors.darken(colors.normalColors.orange, 0), "SKIP", "bold")
  ucolors.highlight("VimwikiHeader4", ucolors.darken(colors.normalColors.orange, 0.3), "SKIP", "bold")
  ucolors.highlight("VimwikiHeader5", ucolors.darken(colors.normalColors.pink, 0), "SKIP", "bold")
  return ucolors.highlight("VimwikiHeader6", ucolors.darken(colors.normalColors.pink, 0.3), "SKIP", "bold")
end
