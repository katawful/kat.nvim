...
local function high_colors()
  return {{group = "vimCommentTitle", fg = colors.kat.bg.shadow.color, bg = colors.kat.fg.shadow.color, ctermfg = groups.umbraBG()[2], ctermbg = groups.umbraFG()[2], bold = true, italic = true}, {group = "vimBracket", fg = colors.kat.pink.match_fg.color, bg = "SKIP", ctermfg = groups.fillBG()[2], ctermbg = "SKIP"}, {group = "vimMapModKey", fg = colors.kat.pink.match_fg.color, bg = "SKIP", ctermfg = groups.fillBG()[2], ctermbg = "SKIP"}, {group = "vimFuncSID", fg = colors.kat.fg.umbra.color, bg = "SKIP", ctermfg = groups.umbraFG()[2], ctermbg = "SKIP"}, {group = "vimSetSep", fg = colors.kat.fg.umbra.color, bg = "SKIP", ctermfg = groups.umbraFG()[2], ctermbg = "SKIP"}, {group = "vimSep", fg = colors.kat.fg.umbra.color, bg = "SKIP", ctermfg = groups.umbraFG()[2], ctermbg = "SKIP"}, {group = "vimContinue", fg = colors.kat.fg.umbra.color, bg = "SKIP", ctermfg = groups.umbraFG()[2], ctermbg = "SKIP"}, {group = "vimOperParen", link = "Variable"}, {group = "vimFunction", link = "Function"}, {group = "vimIsCommand", link = "Identifier"}, {group = "vimUserFunc", link = "Function"}}
end
