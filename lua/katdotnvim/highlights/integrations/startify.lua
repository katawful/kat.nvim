...
local function init()
  ucolors.highlight("StartifyBracket", ucolors.blendColors(groups.selectionBG()[1], groups.meldBG()[1], 0.5), "SKIP", groups.selectionBG()[2], "SKIP", "bold")
  ucolors.highlight("StartifyFile", ucolors.blendColors(groups.highlightBG()[1], groups.mainFG()[1], 0.8), "SKIP", groups.highlightBG()[2], "SKIP", "bold")
  ...
  ucolors.highlight("StartifySection", ucolors.blendColors((colors.init("normalColors")).red, groups.mainFG()[1], 0.8), "SKIP", groups.warningBG()[2], "SKIP", "bold")
