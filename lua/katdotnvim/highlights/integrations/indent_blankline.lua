...
local function high_colors()
  return {{group = "IndentBlanklineChar", fg = colors.kat.bg.shadow.color, bg = "SKIP", ctermfg = 8, ctermbg = "SKIP", nocombine = true}, {group = "IndentBlanklineSpaceChar", fg = colors.kat.bg.shadow.color, bg = "SKIP", ctermfg = 8, ctermbg = "SKIP", nocombine = true}, {group = "IndentBlanklineSpaceChar", fg = colors.kat.bg.shadow.color, bg = "SKIP", ctermfg = 8, ctermbg = "SKIP", nocombine = true}, {group = "IndentBlanklineContextChar", fg = colors.kat.blue.base.color, bg = "SKIP", ctermfg = 4, ctermbg = "SKIP", nocombine = true}}
end
