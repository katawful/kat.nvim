...
local function high_colors()
  return {{group = "fugitiveHunk", fg = "SKIP", bg = colors.kat.bg.shadow.color, ctermfg = "SKIP", ctermbg = 8, nocombine = true}, {group = "gitDiff", fg = "SKIP", bg = colors.kat.bg.shadow.color, ctermfg = "SKIP", ctermbg = 8, nocombine = true}}
end
