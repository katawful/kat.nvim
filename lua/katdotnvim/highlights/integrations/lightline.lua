...
local function normalMode_a()
  local output = {mainFG()[1], groups.highlightBG()[1], mainFG()[2], groups.highlightBG()[2], "bold"}
  _2amodule_2a["output"] = output
  return output
end
...
local function visualMode_b()
  local output = {mainFG()[1], ucolors.blendColors(groups.selectionBG()[1], groups.shadowBG()[1], 0.4), mainFG()[2], selectionBG()[3], ""}
  _2amodule_2a["output"] = output
  return output
end
_2amodule_2a["visualMode_b"] = visualMode_b
local function visualMode_a()
  local output = {mainFG()[1], groups.errorBG()[1], mainFG()[2], groups.errorBG()[1], "bold"}
  _2amodule_2a["output"] = output
  return output
end
...
local function terminalMode_c()
  local output = {mainFG()[1], ucolors.blendColors(groups.errorBG()[1], groups.mainBG()[1], 0.8), mainFG()[2], groups.warningBG()[2], ""}
  _2amodule_2a["output"] = output
  return output
end
...
local function terminalMode_a()
  local output = {mainFG()[1], ucolors.blendColors(groups.fillBG()[1], groups.mainBG()[1], 0.8), mainFG()[2], groups.fillBG()[2], "bold"}
  _2amodule_2a["output"] = output
  return output
end
_2amodule_2a["terminalMode_a"] = terminalMode_a
local function inactiveGroup()
  local output = {groups.mainBG()[1], (colors.init("foreground"))[3], groups.mainBG()[2], groups.umbraFG()[2], ""}
  _2amodule_2a["output"] = output
  return output
end
