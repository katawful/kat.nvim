...
local _2amodule_name_2a = "katdotnvim.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("katdotnvim.aniseed.core"), autoload("katdotnvim.aniseed.env"), autoload("katdotnvim.aniseed.eval"), autoload("katdotnvim.aniseed.nvim")
