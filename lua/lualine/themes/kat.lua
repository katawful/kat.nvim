...
if ((vim.g.kat_nvim_style == "dark") and (vim.g.kat_nvim_contrast == "soft")) then
...
kat.command = {a = {bg = ucolors.blendColors(colors.normalColors.green, groups.mainBG, 0.5), fg = mainFG, gui = "bold"}, b = {bg = ucolors.blendColors(groups.selectionBG, groups.shadowBG, 0.4), fg = mainFG}, c = {bg = ucolors.blendColors(colors.normalColors.green, groups.mainBG, 0.7), fg = mainFG}}
